...
def parse_arguments():
    ...
    parser.add_argument(
            ...
            type=str, 
            required=False, 
            default="/scratch2/spower2/scripts/v2scripts/find_genes/Pisum_sativum_v1a_genes.db",
    ...
    parser.add_argument(
            ...
            type=str, 
            required=False, 
            default="/scratch2/spower2/scripts/v2scripts/find_genes/Pisum_sativum.annotation_info.txt",  
...
#add back gene_info after gff_db
...
def find_overlapping_features(snp_groups, gff_db, gene_info, feature_type, outfile):
    ...
    with open(outfile, 'w') as output:
        ...
        for key, value in snp_groups.items():
            ...
            region = "chr{0}:{1}-{2}".format(chromosome,
                    minimum, 
                    maximum) 
            ...
            try:
                for line in gff_db.region(region, featuretype=feature_type):
                    ...
                    try:
                        ...
                        output.write("{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\n".format(key,                                                                 chromosome,                                                                                                             position,                                                                                                               snp_count,                                                                                                              gene_id,                                                                                                                gene_start,                                                                                                             gene_end,                                                                                                               "."
                            ))
            except ValueError:
                continue
